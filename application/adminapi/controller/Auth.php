...
//        $params['pid']
        if($params['pid'] ==0){
            ...
            //修改上级的权限pid 重新设置level级别 和pid_path家族族谱
    ...
    public function  nav(){
        ...
        if($role_id==1){
            ...
            //在查询角色表
            $data =\app\common\model\Auth::where('is_nav',1)->where('id',id,$role_auth_ids)->select();
